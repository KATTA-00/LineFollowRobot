...
int val[5] = {-15,-10,0,10,15};
float pid_val ;

float sp_left = 125 + 17.5;
float sp_right = 125;
int shift = 0;
float left = sp_left ;
...
void gear(){
  sp_left = 125 + 17.5;
  sp_right = 125;
  if ((ir[1] == 1 || ir[3] == 1) && (ir[2]*ir[1] == 0 && ir[2]*ir[3] == 0 )){
    sp_left = sp_left * gear1;
    sp_right = sp_right * gear1;
  } else if ((ir[0] == 1 || ir[4] == 1) && (ir[0]*ir[1] == 0 && ir[4]*ir[3] == 0 )){
